...
const JOKES = [
	...
	"What did the JavaScript developer say when his code didn’t work? 'You must be async.'",
	...
	"Why are programming languages like dating? Because they all have their pros and cons, but you keep coming back to the one you’re most comfortable with.",
	"What do you call a group of 8 hobbits? A byte.",
	"Why did the Python programmer break up with his girlfriend? Because she couldn’t handle his recursion.",
	...
	"Why do JavaScript developers prefer coffee? Because it’s Java.",
	...
	"Why don’t programmers like working with numbers? They always have too many digits.",
	...
	"Why do web developers always seem to be at the gym? They’re always working on their flexbox.",
	"Why did the Python script run away from home? Because it didn’t want to be imported anymore.",
	"Why do Java developers use beans? Because they’re better than just talking.",
	"Why do coders prefer dark coffee? Because they can't handle the light.",
	"Why did the array fail math class? Because it couldn’t find its value.",
	...
	"What’s the best way to make a decision in programming? Flip a coin and call it a 'Boolean' decision.",
	"Why was the website so bad at making decisions? It kept redirecting everything.",
	"Why do developers hate elevators? They don’t have enough control flow.",
	"Why did the computer go to the doctor? It had a virus.",
	"Why do developers love open source? Because it’s the best way to get bugs for free.",
	"Why don’t JavaScript developers use the elevator? They prefer callbacks.",
	"Why do web developers love autumn? Because of all the changes in leaves.",
	"What’s the difference between a developer and a musician? One plays with code, the other plays with notes.",
	"Why did the function hate its job? It was always returning nothing.",
	"What do you call a developer who can’t make decisions? A NULL pointer.",
	"Why did the Python developer get caught in the rain? He didn’t have a try block.",
	"What did the coder say to the server? 'I’m your client.'",
	...
	"What did the database say to the query? 'I’ve got your back, just join me!'",
	"Why did the programmer’s wife leave him? Because he had no class.",
	"Why do programmers always mix up Christmas and Halloween? Because Oct 31 == Dec 25.",
	"Why was the router so good at making friends? Because it always knew how to connect.",
	"What did the programmer do after getting a haircut? He updated his ‘repo’.",
	...
	"What’s the difference between a programmer and a marketer? One has a lot of bugs, and the other creates them.",
	"Why did the developer start gardening? Because he loved working with arrays.",
	"What’s a programmer’s favorite exercise? Crunching numbers.",
	"Why do Python programmers prefer snakes? They’re comfortable with long-tails.",
	"Why was the CSS code so good at relationships? Because it always aligned perfectly.",
	"Why do programmers prefer cats? Because they’re independent and don’t need constant updates.",
	"What do you call a programmer who likes to eat pasta? A spaghetti coder.",
	"What’s a developer’s favorite kind of coffee? Java.",
	"Why did the Python developer get frustrated with his car? Because it was always giving him exceptions.",
	"Why don’t programmers like Star Wars? Because they can’t handle the Force.",
	"Why did the web developer break up with the front end? Because it wasn’t responsive enough.",
	"Why don’t Java developers use float? Because they don’t trust anything without precision.",
	"What’s the most common phrase in programming? 'It works on my machine.'",
	...
	"What’s a developer’s favorite part of a beach? The array of sandcastles.",
	...
	"What did the SQL server say to the client? 'I’m going to make you an offer you can’t refuse.'",
	"Why do programmers use version control? To keep track of their past mistakes.",
	"Why did the developer get kicked out of the party? He couldn’t stop talking about his stack.",
	"What’s a Java developer’s favorite type of relationship? One that’s strongly typed.",
	"What did the server say to the client after a good connection? 'That’s what I call a successful handshake.'",
	"Why do programmers love cats? Because they’re good at catching exceptions.",
	...
	"What’s the first thing a developer does when they wake up? They check if their code has been pushed.",
	"Why do programmers prefer using ‘&&’ instead of ‘&’? Because they like to keep things short-circuited.",
	"What did the developer say when his code finally compiled? 'It’s alive!'",
	"Why did the HTML element break up with the CSS? Because it felt boxed in.",
	"What’s the best way to make a decision in programming? Flip a coin and call it a Boolean decision.",
	"Why do Java developers use ‘beans’? Because they’re better than just talking.",
	"What do you call a developer who loves to fix bugs? A debugger.",
	"What do you call a function that’s always working? A constant.",
	"Why did the developer fall asleep? Because he was caught in an infinite loop.",
	"What’s a JavaScript developer’s favorite dish? JSON!",
	"Why do developers hate finding bugs? It’s a never-ending loop.",
	"What do you get when you cross a joke with a bug? A pun-derful error.",
	"Why did the JavaScript developer give up on his relationship? Because he didn’t get the callback.",
];
