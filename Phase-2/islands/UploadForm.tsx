        ...
        <form onSubmit={handleUpload} className="upload-form">
            ...
            {selectedOption === "file" ? (
                <div className="file-input-row">
                    <label htmlFor="file" className="upload-label">Select a package:</label>
                    <input
                        type="file"
                        id="file"
                        accept=".zip"
                ...
                <div className="url-input-row">
                    <label htmlFor="url" className="upload-label">Enter package URL:</label>
                    <input
                        type="text"
                        id="url"
                        value={inputUrl}
            ...
            <div className="debloat-container">
                <label htmlFor="debloat" className="upload-label">Debloat:</label>
                <div className={`custom-checkbox ${debloat ? "checked" : ""}`} onClick={() => setDebloat(!debloat)}>
                    <input
                        type="checkbox"
                        id="debloat"
                        checked={debloat}
            ...
            <div>
                <label htmlFor="auth-token" className="upload-label">Authorization Token (X-Authorization):</label>
                <input
                    type="text"
                    id="auth-token"
                    value={authToken}
